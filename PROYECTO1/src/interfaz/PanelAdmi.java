...
public class PanelAdmi {
    ...
    static public void iniciarSesionAdmin(Stage primaryStage, Scene escenaPrincipal, SistemaAlquiler sistema) {
        ...
        btnContinuar.setOnAction(e -> {
            ...
            if (autenticarAdmin(nombreUsuario, contrasena)) {
                // Si la autenticación es exitosa, mostrar el menú del administrador y actualizar la ventana principal
    ...
    private static void mostrarMenuAdmin(Stage primaryStage, Scene escenaPrincipal, SistemaAlquiler sistema) {
        // Crear la disposición para el menú del administrador
        ...
        // Configurar acciones de los botones del menú de administrador
        ...
        // Agregar nodos al diseño del menú de administrador
        ...
        // Crear la nueva escena del menú de administrador
